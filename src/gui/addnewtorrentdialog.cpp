...
void AddNewTorrentDialog::loadState()
{
    ...
    m_ui->contentWidget->loadState(settings()->loadValue<QByteArray>(KEY_TREEHEADERSTATE));
}
...
void AddNewTorrentDialog::saveState()
{
    ...
    if (m_hasMetadata)
        settings()->storeValue(KEY_TREEHEADERSTATE, m_ui->contentWidget->saveState());
}
...
void AddNewTorrentDialog::setupTreeview()
{
    ...
    else
    {
        ...
        m_ui->contentWidget->setTorrent(&m_torrentInfo);
    }
